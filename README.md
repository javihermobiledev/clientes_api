...
NOTA: Si utiliza Visual Studio Code asegurese de instalar las extesiones necesarias:
...
- **Maven for Java:** Como el proyecto está basado en Maven, esta extensión permitirá ejecutar y gestionar las dependencias.
...
La aplicación está configurada para que las tablas se creen automáticamente al iniciar, y los datos iniciales se inserten automáticamente usando Hibernate y los scripts SQL proporcionados.
